...
const server = new McpServer(
  {
    ...
    version: "2.0.0",
    description:
      "MCP server for Matcha LuaVM — execute Luau, inspect instances, decompile scripts, read/write memory. Dashboard: http://localhost:16385/.",
  },
  {
    instructions: [
      "Matcha MCP server (Matcha LuaVM, not an executor). Docs: https://doc.wabisabi.mom/matcha/",
      "Recommended workflow to keep results small and accurate:",
